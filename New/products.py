...
def add_product_to_list(new_id, name, price):
    ...
    with connection.cursor(pymysql.cursor.DictCursor) as cursor:
        ...
        sql = "INSERT INTO Products ({}, {}, {}) VALUES (%s, %s, %s)".format(
            new_id, name, price)
        val = ("{}".format(new_id), "{}".format(name), "{}".format(price))
...
def update_name(select):
    ...
    with connection.cursor(pymysql.cursor.DictCursor) as cursor:
        sql = "UPDATE Products SET name = '{}' WHERE id = '{}'".format(new_name, the_id)
...
def update_price(selected):
    ...
    if new_price != "":
        try:
            ...
            with connection.cursor(pymysql.cursor.DictCursor) as cursor:
                sql = "UPDATE Products SET price = '{}' WHERE id = '{}'".format(new_price, the_id)
...
def removal_of_product():
    ...
    with connection.cursor(pymysql.cursor.DictCursor) as cursor:
        sql = "DELETE FROM Products WHERE id = '{}'".format(the_id)
